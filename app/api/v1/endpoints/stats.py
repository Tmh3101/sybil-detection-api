...
from app.schemas.stats import (
    OverviewResponse, EdgeDistributionItem,
    RiskDistributionResponse, RiskDistributionItem,
    TrustScoreResponse, TrustScoreBin,
...
EDGE_LAYER_MAP = {
    "FOLLOW": "Follow", "FOLLOW_REV": "Follow",
    "UPVOTE": "Interact", "UPVOTE_REV": "Interact",
    "REACTION": "Interact", "REACTION_REV": "Interact",
    "COMMENT": "Interact", "COMMENT_REV": "Interact",
    "QUOTE": "Interact", "QUOTE_REV": "Interact",
    "MIRROR": "Interact", "MIRROR_REV": "Interact",
    "COLLECT": "Interact", "COLLECT_REV": "Interact",
    "TIP": "Interact", "TIP_REV": "Interact",
    "CO-OWNER": "Co-Owner",
    "SIMILARITY": "Similarity",
    "FUZZY_HANDLE": "Similarity", "SIM_BIO": "Similarity",
...
async def get_trust_scores(request: Request):
    ...
    bins[-1] = TrustScoreBin(
        range_label="90-100",
        count=sum(1 for s in scores if 90 <= s <= 100)
    )
...
async def get_cluster_stats(request: Request):
    ...
    if not cluster_counts:
        return ClusterStatsResponse(
            total_clusters=0, avg_cluster_size=0.0,
            largest_cluster=0, smallest_cluster=0
        )
